...
const Hero = () => {
  return (
    <main className="relative pt-2" style={{ background: 'linear-gradient(135deg, #674cdc 0%, #5a3ec9 50%, #4d30b6 100%)', paddingBottom: '150px', overflow: 'hidden' }}>
      ...
      {/* MAIN CONTAINER */}
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-6 py-4 md:py-6 relative" style={{ zIndex: 10 }}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 lg:space-y-3 animate-fadeIn">
              ...
              <div className="relative overflow-visible rounded-full">
                ...
                <div className="lg:hidden absolute inset-0 pointer-events-none" style={{ borderRadius: '9999px' }}>
                  <div className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 opacity-60"
                       style={{ animation: 'runAlongBorder 8s linear infinite' }}>
                  ...
                  <div className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 opacity-60"
                       style={{ animation: 'runAlongBorder 8s linear infinite 2s' }}>
                  ...
                  <div className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 opacity-60"
                       style={{ animation: 'runAlongBorder 8s linear infinite 4s' }}>
                  ...
                  <div className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 opacity-60"
                       style={{ animation: 'runAlongBorder 8s linear infinite 6s' }}>
            ...
            {/* Heading - FIX: CHỮ CÙNG HÀNG + FONT NHỎ HƠN */}
            <h1 className="text-4xl xs:text-5xl sm:text-6xl
                   lg:text-6xl xl:text-7xl
                   font-black lg:font-bold 
                   tracking-tight leading-tight
                   text-left">
              
              <span className="block text-white drop-shadow-2xl lg:drop-shadow-lg mb-2 lg:mb-1">
                Hoàn Phí Giao Dịch
              </span>
              <span className="block">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-400 to-cyan-500 lg:via-blue-300 lg:to-cyan-400 drop-shadow-2xl">
                  An toàn
                </span>
              </span>
            </h1>
            ...
            <p className="text-base sm:text-lg lg:text-lg 
                          ...
                          drop-shadow-md text-left !mt-5 lg:!mt-3">
              Chúng tôi xử lý hoàn phí nhanh chóng trên các sàn Crypto, Forex. 
              Các bạn sẽ nhận được <span className="text-green-300 font-bold text-lg lg:text-base">40-60%</span> phí giao dịch của mình vào mỗi tháng kèm nhiều ưu đãi.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 lg:gap-3 !mt-6 lg:!mt-4">
              <Link
                to="/services"
                className="group inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-green-400 via-emerald-500 to-green-600 lg:via-emerald-400 lg:to-green-500 text-white px-7 py-3.5 lg:px-7 lg:py-3.5 rounded-full font-bold text-base lg:text-base shadow-2xl lg:shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:from-green-500 hover:to-emerald-600 lg:hover:to-emerald-500"
              >
                <span className="text-xl lg:text-xl group-hover:animate-bounce">🚀</span>
                <span>Đăng ký & Nhận Hoàn</span>
                <span className="ml-2 w-2 lg:w-2 h-2 lg:h-2 rounded-full bg-red-500 animate-pulse" />
              </Link>

              <Link
                to="/news/2"
                className="inline-flex items-center justify-center gap-2.5 bg-white/10 backdrop-blur-sm border-2 border-white/40 lg:border-white/30 text-white px-6 py-3.5 lg:px-6 lg:py-3.5 rounded-full shadow-lg lg:shadow-md hover:shadow-xl hover:border-white/60 lg:hover:border-white/50 hover:bg-white/20 transform transition-all duration-300 hover:scale-105 font-semibold text-base lg:text-base"
              >
                <span>ℹ️</span> 
                    ...
                    <div className="absolute bottom-6 left-6 z-10">
                      <div className="relative">
                        ...
                        <div className="relative px-5 py-3">
                          <p className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-emerald-400 to-cyan-400"
                             style={{
